...
module.exports = class Planet {
  ...
  static async search (query) {
    const cmd = knex
      .select(knex.raw('distinct on (CONCAT(planets.galaxy, \':\', planets.system, \':\', planets.position)) *, planets.galaxy, planets.system, planets.position, planets.planet_id, EXTRACT(EPOCH FROM now() - reports.created_at)/3600 as report_age_hrs, planets.updated_at'))
      .from('planets')
      ...
      .limit(Math.min(parseInt(query.limit), 1000))
